    ...
    <div className="min-h-screen py-16 px-4 flex items-center justify-center relative overflow-hidden">
      <div className="max-w-6xl mx-auto text-center">
        ...
        <div className="relative mb-4">
          ...
          <div className="absolute -top-4 left-1/4 text-3xl animate-heartbeat opacity-80">💝</div>
          <div className="absolute -top-2 right-1/4 text-2xl animate-twinkle opacity-70">✨</div>

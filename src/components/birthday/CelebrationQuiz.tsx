    ...
    <div className="min-h-screen py-16 px-4 flex items-center justify-center">
      <div className="max-w-2xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {questions[currentQuestion].options.map((option, index) => (
                  <Button
                    ...
                    className="text-lg py-6 h-auto hover:bg-gradient-celebration transition-bounce hover:scale-105"
                  >
                    {option}
                  </Button>
                ))}
        ...
        <div className="mt-8 bg-muted rounded-full h-2 overflow-hidden">
          <div 
            className="bg-gradient-celebration h-full transition-smooth rounded-full"

...
export const CelebrationMessages: React.FC<CelebrationMessagesProps> = ({ onNext }) => {
  ...
  const loveMessages = [
    ...
    "On this special celebration, my beautiful girl. May your dreams come true and may our bond grow stronger with every year.",
    "",
    "With so much love, 💕"
  ];
    ...
    <div className="min-h-screen py-16 px-4 flex items-center justify-center relative">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-16 animate-fade-in relative">
          ...
          <div className="absolute -top-2 left-1/3 text-2xl animate-twinkle opacity-75" style={{ fontFamily: 'Apple Color Emoji, Segoe UI Emoji, Noto Color Emoji, sans-serif' }}>🌸</div>
          <div className="absolute -bottom-4 right-1/4 text-2xl animate-float opacity-70" style={{ fontFamily: 'Apple Color Emoji, Segoe UI Emoji, Noto Color Emoji, sans-serif' }}>💗</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          <Card className="bg-gradient-celebration p-6 shadow-card hover:shadow-soft transition-bounce hover:scale-105 animate-fade-in backdrop-blur-sm">
          ...
          <Card className="bg-gradient-surprise p-6 shadow-card hover:shadow-soft transition-bounce hover:scale-105 animate-fade-in backdrop-blur-sm">
            <div className="text-center">
              ...
              <p className="text-lg font-medium text-foreground leading-relaxed font-poppins">
                "Happy Celebration to the one who is so special to me. 💕"
              </p>
            </div>
          </Card>
        </div>
